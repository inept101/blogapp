...
export default function LoginForm({ justRegistered, googleEnabled, githubEnabled }: Props) {
            ...
            <div className="mt-6 space-y-2">
              {googleEnabled && (
                <button
                  ...
                  className="w-full py-3 rounded-xl border border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:border-slate-400 dark:hover:border-slate-600 font-medium transition-colors flex items-center justify-center gap-2 text-sm"
                >
              ...
              {githubEnabled && (
                <button
                  type="button"
                  onClick={() => signIn('github', { callbackUrl: '/blogs' })}
                  className="w-full py-3 rounded-xl border border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-300 hover:border-slate-400 dark:hover:border-slate-600 font-medium transition-colors flex items-center justify-center gap-2 text-sm"
                >
